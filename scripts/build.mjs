...
await build({stdin:{contents:entry,resolveDir:process.cwd(),sourcefile:'worker-entry.js'},bundle:true,format:'esm',platform:'browser',external:['node:*'],target:'es2022',outfile:'dist/server/index.js'});
