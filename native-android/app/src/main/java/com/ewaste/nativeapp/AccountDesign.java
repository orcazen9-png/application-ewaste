...
final class AccountDesign {
    ...
    void home()throws Exception{
        ...
        link(a.page,a.t(collector?"Authorized recyclers":"Posted materials"),a.t(collector?"Find recyclers by material and location":"Browse nearby lots and make an offer"),"home-discover","box",()->a.market.discovery.open(collector));
        a.market.pending();
