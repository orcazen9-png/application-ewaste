...
final class FinanceScreens {
    ...
    void earnings(JSONObject d)throws Exception{a.label(d.optString("role").equals("collector")?a.t("Your earnings"):a.t("Material payments"),23);a.label(a.t("Accepted material quotes ₹")+d.optString("expected","0.00"),18);a.label(a.t("Awaiting receipt confirmation ₹")+d.optString("pending","0.00"),18);a.label(a.t("Quoted values can change. Pending transfers are not confirmed earnings."),14);a.label(a.t("Confirmed ₹")+d.optString("confirmed")+a.t("\nApproved invoices ₹")+d.optString("approved")+a.t("\nOutstanding ₹")+d.optString("outstanding"),19);a.label(a.t("Totals use collector-confirmed material payments. Logistics is accounted separately."),15);JSONArray orders=d.optJSONArray("orders");if(orders!=null)for(int i=0;i<orders.length();i++){JSONObject o=orders.getJSONObject(i);a.label(a.t(o.optString("paymentState"))+" · ₹"+o.optString("confirmed"),17);a.button(a.t("Open financial record"),"earnings-order-"+i,()->open(o.optString("id")));}}
