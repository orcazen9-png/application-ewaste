const CACHE='ewaste-foundation-v5';
const FILES=['./','./index.html','./styles.css','./app.js','./domain.js','./transactions.js','./workflows.js','./flow-i18n.js','./sync.js','./store.js','./icons.js','./equipment.js','./recognition.js','./lot-classification.js','./lot-photo-view.js','./waste-catalog.js','./i18n.js','./icon.svg','./manifest.webmanifest'];
